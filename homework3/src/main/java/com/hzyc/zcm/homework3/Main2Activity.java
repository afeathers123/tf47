...
public class Main2Activity extends AppCompatActivity {
    ...
    private Button add,addBack,addImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addHead = (ImageView) findViewById(R.id.addHead);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SQLiteDatabase sqLiteDatabase = new OpenSqlite(Main2Activity.this).getReadableDatabase();

                String name = addName.getText().toString().trim();
                String phone = addPhone.getText().toString().trim();

                sqLiteDatabase.execSQL("insert into addressList (name,phone) values (?,?)", new Object[]{name,phone});
